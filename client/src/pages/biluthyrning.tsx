          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="mt-12">
              ...
              <div className="mb-6 text-center">
                <p className="text-neutral-600 mb-4">Här ser du priser för personbilar och minibussar. För en fullständig prislista inklusive skåpbilar, släp och takboxar, besök vår prissida.</p>
                <Link href="/priser">
                  <a className="inline-flex items-center bg-primary text-white px-6 py-3 rounded-md hover:bg-primary-dark transition text-lg font-medium">
