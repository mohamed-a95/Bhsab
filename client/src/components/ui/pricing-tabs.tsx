    ...
    <Tabs defaultValue="personbilar-minibussar" className="w-full" onValueChange={setActiveTab}>
      <TabsList className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 mb-10 bg-neutral-100 p-1 rounded-lg shadow-sm">
        <TabsTrigger 
          ...
          className="text-base font-medium py-3 transition-all hover:bg-white/50 data-[state=active]:bg-white data-[state=active]:shadow-sm data-[state=active]:border-primary data-[state=active]:text-primary"
        >
